                       ...
                       <div className="flex flex-col space-y-8 flex-grow h-full">
                          {/* items order */}
                            <div className="flex flex-col max-h-60 space-y-4 overflow-auto">
                              <div className="flex flex-none bg-stone-700 flex-none rounded-md relative p-2 h-14 cursor-pointer text-xs overflow-hidden transition-all duration-500 delay-200 ease-in-out translate-x-0">
                          ...
                          {/* calcul */}
                            <div className="flex flex-col justify-between flex-grow bg-[#2d2d2d] p-4 rounded-md transition-all duration-500 delay-200 ease-in-out translate-x-0">
                                <div>
                                  jddjj
                                </div>
